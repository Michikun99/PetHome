...
const fs = require('fs');
const Tesseract = require('tesseract.js'); // ✨ NUEVO: Inteligencia Artificial OCR
...
const db = mysql.createConnection({
    ...
    user: 'root',
    password: 'LjCFRoWWKuILeCTjxMvTIuyfjKdjCjWl',
    database: 'railway',
    port: 24923
});
...
db.connect((err) => {
    ...
    console.log('✅ PetHome Conectado a Railway (IA y Restricciones Activas)');
});
...
app.listen(3000, () => console.log('🚀 Backend PetHome en puerto 3000'));